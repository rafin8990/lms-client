  ...
  return (
    <div className="bg-[#262D36] lg:p-16">
      <div className="lg:w-[1440px] mx-auto pt-10 grid grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="ml-5">
          <Link to="/">
            <h1 className="link link-hover text-white">Home</h1>
          </Link>
          <Link to="/dashboard">
            {" "}
            <h1 className="link link-hover text-white">DashBoard</h1>
          </Link>
          <Link to="/about">
            {" "}
            <h1 className="link link-hover text-white">About</h1>
          </Link>
        </div>
        <div className="ml-5">
          <Link to="/courses">
            {" "}
            <h1 className="link link-hover text-white">Courses</h1>
          </Link>
          <Link to="/collaboration">
            {" "}
            <h1 className="link link-hover text-white">Collaboration</h1>
          </Link>
          <Link to="/contact">
            {" "}
        ...
        <div className="ml-5 mr-5 flex">
          <Link to="https://www.facebook.com">
            <h1 className="text-2xl ml-3 text-white">
      ...
      <div>
        <h1 className="text-white   my-5 text-center">
          Copyright @ swachh Akshar || All rights reserve
        </h1>
      </div>
    </div>
  );
