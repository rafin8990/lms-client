...
const WhatWeDo = () => {
    ...
    return (
        <div className='bg2 lg:p-32'>
            ...
            <Fade right>
                <p className='font-2 text-center mt-5 mx-5 lg:mx-0 text-white'>Swachh Akshar provides service to improve your public image. Be it brand, political figure, public figure or business figure. <br />
                    ...
                    services.map(service => <div 
                        ...
                        className="card w-96 bg-base-100 shadow-xl">
                          <div className="card-body">
                            ...
                            <p className='font2'>If a dog chews shoes whose shoes does he choose?</p>
            ...
            <div className='flex justify-center py-10'>
                <Link to='/services'><button className='btn btn-outline text-white border-[#FA383E] hover:bg-[#FA383E] hover:text-white hover:border-none font2'>Show More</button></Link>
            </div>
        </div>
    );
};
