...
const Counter = () => {
    return (
        <div className=' bg-[#FCD752] py-32'>
            ...
            <div>
                <Fade right>
                    <h1 className=' text-xl md:text-4xl font-bold text-white text-center mx-5 lg:mx-0'>SWACHH AKSHAR IN NUMBERS</h1>
                </Fade>
                <Fade left>
                    <p className='text-white text-center mx-10 lg:mx-0'>Some facts which will tell you more about us…</p>
                </Fade>
                <div className='lg:w-[1440px] mx-5 lg:mx-auto  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mt-10'>
                    <Fade left>
                        <div className='p-10 bg-yellow-300 rounded-2xl text-center my-3'>
